...
public class PacketPlayOutPlayerInfo implements Packet<PacketListenerPlayOut> {
    ...
    public void a(PacketDataSerializer var1) throws IOException {
        ...
        for (int var3 = 0; var3 < var2; ++var3) {
            ...
            switch (this.a) {
                ...
                case ADD_PLAYER: {
                    var4 = new GameProfile(var1.i(), var1.e(16));
                    int var8 = var1.g();
                    int var9 = 0;

                    for (; var9 < var8; ++var9) {
                        String var10 = var1.e(32767);
                        String var11 = var1.e(32767);
                        if (var1.readBoolean()) {
                            var4.getProperties().put(var10, new Property(var10, var11, var1.e(32767)));
                        } else {
                            var4.getProperties().put(var10, new Property(var10, var11));
                        }
                    }

                    var6 = EnumGamemode.getById(var1.g());
                    var5 = var1.g();
                    if (var1.readBoolean()) {
                        var7 = var1.f();
                    }
                ...
                case UPDATE_GAME_MODE: {
                    var4 = new GameProfile(var1.i(), null);
                    var6 = EnumGamemode.getById(var1.g());
                }
                break;
                case UPDATE_LATENCY: {
            ...
            while (var2.hasNext()) {
                ...
                switch (this.a) {
                    ...
                    case ADD_PLAYER: {
                        ...
                        var1.d(var3.a().getProperties().size());
    ...
    public class PlayerInfoData {
        ...
        public PlayerInfoData(GameProfile var2, int var3, EnumGamemode var4, @Nullable IChatBaseComponent var5) {
            this.d = var2;
            this.b = var3;
            this.c = var4;
            this.e = var5;
