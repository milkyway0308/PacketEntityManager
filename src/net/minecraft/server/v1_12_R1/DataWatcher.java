...
public class DataWatcher {
    ...
    private final Map<Integer, Item<?>> d = Maps.newHashMap();
    ...
    private <T> DataWatcher.Item<T> c(DataWatcherObject<T> datawatcherobject) {
        ...
        try {
            ...
            CrashReport crashreport = CrashReport.a(var6, "Getting synched entity data");
